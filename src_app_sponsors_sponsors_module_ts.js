...
function SponsorsInfoComponent_ng_container_11_tr_14_li_10_Template(rf, ctx) {
  if (rf & 1) {
...
function SponsorsInfoComponent_ng_container_11_tr_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](5, "td", 24)(6, "a", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](7, "Contact Us");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](8, "td", 25)(9, "ul", 26);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](10, SponsorsInfoComponent_ng_container_11_tr_14_li_10_Template, 2, 1, "li", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()()();
  }
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpropertyInterpolate1"]("href", "mailto:sponsor@iowacodecamp.com?subject=Iowa Code Camp ", level_r8.sponsor_level, " Inquiry", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsanitizeUrl"]);
...
function SponsorsInfoComponent_ng_container_11_section_15_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "section", 27)(1, "div", 28)(2, "h2", 29);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
...
function SponsorsInfoComponent_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](14, SponsorsInfoComponent_ng_container_11_tr_14_Template, 11, 4, "tr", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]()()()();
...
class SponsorsInfoComponent {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
    ...
    decls: 13,
    vars: 2,
    consts: [[1, "bg-gray-light", "px-16"], [1, "max-w-1024", "mx-auto"], [1, "flex", "justify-center", "gap-16", "flex-col", "sm:flex-row", "py-20", "w-full", "items-center"], [1, "w-92"], ["href", "/", "ng-reflect-router-link", "/", 1, "block"], ["class", "text-center sm:text-right sm:ml-auto", 4, "ngIf"], [1, "pt-60", "pb-40"], ["alignment", "center", "text", "Sponsorship Information"], [4, "ngIf"], [1, "text-center", "sm:text-right", "sm:ml-auto"], ["target", "_blank", 3, "href"], [3, "href"], [1, "mb-60", "px-16"], [1, "max-w-640", "mx-auto"], [1, "w-full", "text-left"], [4, "ngFor", "ngForOf"], [1, "max-w-1024", "mx-auto", "w-full", "overflow-x-auto"], [1, "w-full", "text-left", "min-w-[800px]"], ["class", "whitespace-nowrap align-top h5 text-white px-16 py-8 bg-red capitalize", 4, "ngFor", "ngForOf"], ["class", "bg-red py-72 px-16", 4, "ngIf"], [1, "align-top", "pr-16", "py-20", "border-b", "border-gray-medium", "capitalize"], [1, "align-top", "py-20", "border-b", "border-gray-medium"], [1, "whitespace-nowrap", "align-top", "h5", "text-white", "px-16", "py-8", "bg-red", "capitalize"], [1, "align-top", "whitespace-nowrap", "px-16", "py-20", "border-b", "border-gray-medium", "bg-gray-light"], [1, "align-top", "px-16", "py-20", "border-b", "border-gray-medium"], [1, "align-top", "px-16", "py-30", "border-b", "border-gray-medium"], [1, "ul"], [1, "bg-red", "py-72", "px-16"], [1, "text-center", "text-white", "max-w-640", "mx-auto"], [1, "h3"], [1, "p", "py-20"]],
...
module.exports = JSON.parse('{"contact_info":{"website":"www.iowacodecamp.com","email":"sponsors@iowacodecamp.com"},"general_info":{"about":"We\'ve hosted free software development conferences since 2008. Our events are funded only by the good will of the community and sponsors like you!","audience":"Computer software industry in Iowa and surrounding states.","attendees":"Averages 240 attendees, primarily computer software developers who are engaged in self improvement and their careers.","reach":"Email list of 2,000 recipients, made up almost completely of those that have attended an event in the past."},"callout_block":{"heading":"Swag For Your Bag","copy":"We are always interested in having swag from our sponsors to either put in the attendees\' bag or to set out for them to pick up. If you have items you would like to distribute, please let us know."},"sponsor_levels":[{"sponsor_level":"Lunch Sponsor","remaining":"1","cost":"","benefits":["Lunch is promoted as \'sponsored by\' your organization","Example: \'Lunch sponsored by ABC Company\'","You can display organization signage at the lunch event.","A table provided at the event to use how you see fit.","Prominent logo placement among sponsors.","Mentions at the event general sessions.","Exposure on marketing materials and logo on the sponsor sheet handout.","Logo on our sponsor sheet handout.","Linked logo on our web site sponsors page."]},{"sponsor_level":"After Party Sponsor","remaining":"1","cost":"$2,500","benefits":["After party promoted with the name of your organization. Example: \'After Party sponsored by The ABC Company\'.","The opportunity to exclusively distribute swag at after party and send representatives to mingle with developers.","A table provided at the event to use how you see fit.","Prominent logo placement among sponsors.","Mentions at the event general sessions.","Exposure on marketing materials and logo on the sponsor sheet handout.","Logo on our sponsor sheet handout.","Linked logo on our web site sponsors page."]},{"sponsor_level":"Breakfast Sponsor","remaining":"1","cost":"$2,500","benefits":["Breakfast is promoted as \'sponsored by\' your organization. Example: \'Breakfast sponsored by The ABC Company\'","You can display organization signage at the breakfast event.","A table at the event to use how you see fit.","Your logo receives the most prominent placement among sponsors.","Mentions at the event general sessions.","Exposure on marketing materials and logo on the sponsor sheet handout.","Logo on our sponsor sheet handout.","Linked logo on our web site sponsors page."]},{"sponsor_level":"Platinum Level","remaining":"5","cost":"$2,000","benefits":["A table at the event to use how you see fit.","A room named after your organization during the event.","Your logo receives prominent placement among sponsors.","Mentions at the event general sessions.","Exposure on marketing materials and logo on the sponsor sheet handout.","Logo on our sponsor sheet handout.","Linked logo on our web site sponsors page."]},{"sponsor_level":"Gold Level","remaining":"5","cost":"$1,000","benefits":["A room named after your organization during the event (availabile on a first come basis).","Mention during the event\'s general sessions.","Exposure on marketing materials and your logo on the sponsor sheet handout.","Logo on our sponsor sheet handout.","Linked logo on our web site sponsors page."]},{"sponsor_level":"Silver Level","remaining":"5","cost":"$500","benefits":["Mention during the event\'s opening session.","Exposure on marketing materials on a space available basis.","Logo on our sponsor sheet handout.","Linked logo on our web site sponsors page."]},{"sponsor_level":"Supporters","remaining":"Unlimited","cost":"$500 value in software licenses and prizes","benefits":["Mention on our sponsor sheet handout.","When giving away donated door prizes, sponsor is named as the donator.","Linked logo on our web site sponsors page."]}]}');
